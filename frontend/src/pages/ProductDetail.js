      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
          ...
          <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
              ...
              <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2'>
                  <img alt='' src={activeImage} className='h-full w-full object-scale-down mix-blend-multiply' onMouseMove={handleZoomImage} onMouseLeave={handleLeaveImageZoom}/>
                          ...
                          data?.productImage?.map((imgURL,index) =>{
                            return(
                              <div className='h-20 w-20 bg-slate-200 rounded p-1' key={imgURL}>
                                <img alt='' src={imgURL} className='w-full h-full object-scale-down mix-blend-multiply cursor-pointer' onMouseEnter={()=>handleMouseEnterProduct(imgURL)}  onClick={()=>handleMouseEnterProduct(imgURL)}/>
                              </div>
                            )
                          })
                        }
            ...
            (
              <div className='flex flex-col gap-1'>
                ...
                <div className='flex items-center gap-2 text-2xl lg:text-3xl font-medium my-1'>
                  <p className='text-red-600'>{displayJPCurrency(data.sellingPrice)}</p>
                  <p className='text-slate-400 line-through'>{displayJPCurrency(data.price)}</p>
                </div>
